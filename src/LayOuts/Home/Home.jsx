            ...
            <div>
                ...
                <div className='grid grid-cols-2 md:grid-cols-4 gap-5 px-[7%] my-15'>
                    <motion.div
                        ...
                        whileInView={'show'}
                        viewport={{ once: false, amount: 0.7 }}
                        className=' p-7 md:p-12 rounded-xl border-1 border-gray-200  shadow-md text-center'>
                    ...
                    <motion.div
                        ...
                        whileInView={'show'}
                        viewport={{ once: false, amount: 0.7 }}
                        className='0 p-7 md:p-12 rounded-xl border-1 border-gray-200 shadow-md text-center'>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {steps.map((step, index) => (
                            <motion.div
                                ...
                                whileInView="show"
                                viewport={{ once: false, amount: 0.7 }}
                                className="p-8  rounded-2xl shadow-lg text-center space-y-4 hover:-translate-y-1.5 hover:shadow-orange-500/20 transition border border-gray-200"
                            >
