...
const Banner = () => {
    return (
        <div>
            ...
            >
                {/* Slide 1 */}
                <div className="relative w-full h-[700px] bg-[url('https://i.ibb.co/Fk2rFyJQ/ray-sangga-kusuma-U2ep-v-QIick-unsplash.jpg')] bg-center bg-cover bg-no-repeat">
                ...
                {/* Slide 2 */}
                <div className="relative w-full h-[700px] bg-[url('https://i.ibb.co/35K4bKQr/charity-poor.png')] bg-center bg-cover bg-no-repeat">
                    <div className="absolute inset-0 bg-[rgba(0,0,0,0.5)]"></div>
                    <div className="absolute top-1/3 left-1/2 -translate-x-1/2 px-6 text-center text-white max-w-2xl z-10">
                        <motion.h2
                            variants={fadeIn('right', 0.1)}
                ...
                {/* Slide 3 */}
                <div className="relative w-full h-[700px] bg-[url('https://i.ibb.co/Ps36rnzK/ochimax-studio-9l-YZIIr8-Cug-unsplash.jpg')] bg-center bg-cover bg-no-repeat">
                    <div className="absolute inset-0 bg-[rgba(0,0,0,0.5)]"></div>
                    <div className="absolute top-1/3 left-1/2 -translate-x-1/2 px-6 text-center text-white max-w-2xl z-10">
                        <motion.h2
                            variants={fadeIn('right', 0.1)}
